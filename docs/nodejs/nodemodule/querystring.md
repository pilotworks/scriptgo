...
| :--- | :--- | :--- | :---: | :--- |
| `querystring.decode()` | `(...) => any` | `__querystring.querystring.decode` | 📋 Planned | - |
| `querystring.encode()` | `(...) => any` | `__querystring.querystring.encode` | 📋 Planned | - |
| `querystring.escape(str)` | `(...) => any` | `__querystring.querystring.escape` | 📋 Planned | - |
| `querystring.parse(str[, sep[, eq[, options]]])` | `(...) => any` | `__querystring.querystring.parse` | 📋 Planned | - |
| `querystring.stringify(obj[, sep[, eq[, options]]])` | `(...) => any` | `__querystring.querystring.stringify` | 📋 Planned | - |
| `querystring.unescape(str)` | `(...) => any` | `__querystring.querystring.unescape` | 📋 Planned | - |
...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/querystring/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
