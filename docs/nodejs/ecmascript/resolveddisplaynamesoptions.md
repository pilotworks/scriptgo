...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/resolveddisplaynamesoptions/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
