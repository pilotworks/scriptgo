# RegExpExecArray Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 RegExpExecArray Specification](https://tc39.es/ecma262/#sec-regexpexecarray-objects)  
...
Corpus test cases for `regexpexecarray` are organized per API under `internal/compiler/testdata/corpus/regexpexecarray/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
