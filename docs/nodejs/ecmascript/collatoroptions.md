# CollatorOptions Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 CollatorOptions Specification](https://tc39.es/ecma262/#sec-collatoroptions-objects)  
...
Corpus test cases for `collatoroptions` are organized per API under `internal/compiler/testdata/corpus/collatoroptions/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/collatoroptions/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
