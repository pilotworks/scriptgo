...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/urlsearchparams/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
