...
| `Uint16Array.findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `__uint16array.findLast` | 📋 Planned | - |
| `Uint16Array.findLastIndex( predicate: ( value: number, index: number, array: this, ) => unknown, thisArg?: any, ): number` | `findLastIndex( predicate: ( value: number, index: number, array: this, ) => unknown, thisArg?: any, ): number` | `__uint16array.findLastIndex` | 📋 Planned | - |
...
| `Uint16Array.new <TArrayBuffer extends ArrayBufferLike = ArrayBuffer>(buffer: TArrayBuffer, byteOffset?: number, length?: number): Uint16Array<TArrayBuffer>` | `new <TArrayBuffer extends ArrayBufferLike = ArrayBuffer>(buffer: TArrayBuffer, byteOffset?: number, length?: number): Uint16Array<TArrayBuffer>` | `__uint16array.new` | 📋 Planned | - |
...
| `new Uint16Array(elements: Iterable<number>): Uint16Array<ArrayBuffer>` | `new (elements: Iterable<number>): Uint16Array<ArrayBuffer>` | `__uint16array.new` | 📋 Planned | - |
