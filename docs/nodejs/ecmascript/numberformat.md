# NumberFormat Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 NumberFormat Specification](https://tc39.es/ecma262/#sec-numberformat-objects)  
...
| :--- | :--- | :--- | :---: | :--- |
| `NumberFormat.format(value: number \| bigint): string` | `format(value: number \| bigint): string` | `__numberformat.format` | 📋 Planned | - |
...
Corpus test cases for `numberformat` are organized per API under `internal/compiler/testdata/corpus/numberformat/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/numberformat/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
