# SharedArrayBuffer Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 SharedArrayBuffer Specification](https://tc39.es/ecma262/#sec-sharedarraybuffer-objects)  
...
Corpus test cases for `sharedarraybuffer` are organized per API under `internal/compiler/testdata/corpus/sharedarraybuffer/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/sharedarraybuffer/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
