# DisplayNamesOptions Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 DisplayNamesOptions Specification](https://tc39.es/ecma262/#sec-displaynamesoptions-objects)  
...
Corpus test cases for `displaynamesoptions` are organized per API under `internal/compiler/testdata/corpus/displaynamesoptions/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/displaynamesoptions/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
