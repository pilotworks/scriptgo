# PluralRulesOptions Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 PluralRulesOptions Specification](https://tc39.es/ecma262/#sec-pluralrulesoptions-objects)  
...
Corpus test cases for `pluralrulesoptions` are organized per API under `internal/compiler/testdata/corpus/pluralrulesoptions/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/pluralrulesoptions/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
