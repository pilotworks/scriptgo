...
> **Specification Reference**: [TC39 ECMA-262 Function Specification](https://tc39.es/ecma262/#sec-function-objects)  
...
| :--- | :--- | :--- | :---: | :--- |
| `Function.apply(this: Function, thisArg: any, argArray?: any): any` | `apply(this: Function, thisArg: any, argArray?: any): any` | `__function.apply` | 📋 Planned | - |
| `Function.arguments: any` | `arguments: any` | `__function.arguments` | 📋 Planned | - |
...
Corpus test cases for `function` are organized per API under `internal/compiler/testdata/corpus/function/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/function/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
