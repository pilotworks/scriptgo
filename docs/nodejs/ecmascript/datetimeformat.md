# DateTimeFormat Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 DateTimeFormat Specification](https://tc39.es/ecma262/#sec-datetimeformat-objects)  
...
| :--- | :--- | :--- | :---: | :--- |
| `DateTimeFormat.format(date?: Date \| number): string` | `format(date?: Date \| number): string` | `__datetimeformat.format` | 📋 Planned | - |
...
Corpus test cases for `datetimeformat` are organized per API under `internal/compiler/testdata/corpus/datetimeformat/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/datetimeformat/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
