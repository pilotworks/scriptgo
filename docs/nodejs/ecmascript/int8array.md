...
| `Int8Array.findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `__int8array.findLast` | 📋 Planned | - |
| `Int8Array.findLastIndex( predicate: (value: number, index: number, array: this) => unknown, thisArg?: any, ): number` | `findLastIndex( predicate: (value: number, index: number, array: this) => unknown, thisArg?: any, ): number` | `__int8array.findLastIndex` | 📋 Planned | - |
...
| `Int8Array.new <TArrayBuffer extends ArrayBufferLike = ArrayBuffer>(buffer: TArrayBuffer, byteOffset?: number, length?: number): Int8Array<TArrayBuffer>` | `new <TArrayBuffer extends ArrayBufferLike = ArrayBuffer>(buffer: TArrayBuffer, byteOffset?: number, length?: number): Int8Array<TArrayBuffer>` | `__int8array.new` | 📋 Planned | - |
...
| `new Int8Array(elements: Iterable<number>): Int8Array<ArrayBuffer>` | `new (elements: Iterable<number>): Int8Array<ArrayBuffer>` | `__int8array.new` | 📋 Planned | - |
