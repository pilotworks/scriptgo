# LocaleOptions Implementation Checklist

> **Category**: `CategoryECMAScript`  
> **Import Path**: `N/A (Global Scope)`  
> **Specification Reference**: [TC39 ECMA-262 LocaleOptions Specification](https://tc39.es/ecma262/#sec-localeoptions-objects)  
...
Corpus test cases for `localeoptions` are organized per API under `internal/compiler/testdata/corpus/localeoptions/<api_name>/<test_case>/` and verify identical lowering semantics across surfaces.
...
- [ ] **Step 6: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/localeoptions/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
