...
| :--- | :--- | :--- | :---: | :--- |
| `Uint8Array.from(elements: Iterable<number>): Uint8Array<ArrayBuffer>` | `from(elements: Iterable<number>): Uint8Array<ArrayBuffer>` | `__uint8array.from` | ✅ Done | `internal/compiler/testdata/corpus/api/uint8array.ts` |
...
| `Uint8Array.findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `findLast<S extends number>( predicate: ( value: number, index: number, array: this, ) => value is S, thisArg?: any, ): S \| undefined` | `__uint8array.findLast` | 📋 Planned | - |
| `Uint8Array.findLastIndex( predicate: (value: number, index: number, array: this) => unknown, thisArg?: any, ): number` | `findLastIndex( predicate: (value: number, index: number, array: this) => unknown, thisArg?: any, ): number` | `__uint8array.findLastIndex` | 📋 Planned | - |
...
| `Uint8Array.fromBase64( string: string, options?: { alphabet?: "base64" \| "base64url" \| undefined` | `fromBase64( string: string, options?: { alphabet?: "base64" \| "base64url" \| undefined` | `__uint8array.fromBase64` | 📋 Planned | - |
...
| `Uint8Array.toBase64( options?: { alphabet?: "base64" \| "base64url" \| undefined` | `toBase64( options?: { alphabet?: "base64" \| "base64url" \| undefined` | `__uint8array.toBase64` | 📋 Planned | - |
...
| `new Uint8Array(elements: Iterable<number>): Uint8Array<ArrayBuffer>` | `new (elements: Iterable<number>): Uint8Array<ArrayBuffer>` | `__uint8array.new` | 📋 Planned | - |
...
- [ ] **Step 5: Corpus Test Directory**: Create test subfolder under `internal/compiler/testdata/corpus/uint8array/<api_name>/<test_case>/` with `main.ts` and `run.expected`.
