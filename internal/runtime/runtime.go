...
//go:embed native/fs/watcher.c
var fsWatcherSource string
...
//go:embed native/crypto/evp.c
var cryptoEVPSource string
...
//go:embed native/json/yyjson.h
var YYJSONHeader string

//go:embed native/json/yyjson.c
var yyjsonSource string
