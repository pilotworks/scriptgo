...
func initIntrinsics() map[string]BuiltinIntrinsic {
	...
	register([]string{"__scriptgo.writeFdSync"}, CategoryNodeModule, "__fs.writeFdSync", nil, ir.TypeNumber, 4, 4)
	...
	register([]string{"__scriptgo.cipherCreate"}, CategoryNodeModule, "__crypto.cipherCreate", nil, ir.TypePointer, 4, 4)
	register([]string{"__scriptgo.cipherUpdate"}, CategoryNodeModule, "__crypto.cipherUpdate", nil, ir.TypeBuffer, 2, 2)
	register([]string{"__scriptgo.cipherFinal"}, CategoryNodeModule, "__crypto.cipherFinal", nil, ir.TypeBuffer, 1, 1)
	register([]string{"__scriptgo.cipherSetAAD"}, CategoryNodeModule, "__crypto.cipherSetAAD", nil, ir.TypeVoid, 2, 2)
	register([]string{"__scriptgo.cipherGetTag"}, CategoryNodeModule, "__crypto.cipherGetTag", nil, ir.TypeBuffer, 1, 1)
	register([]string{"__scriptgo.cipherSetTag"}, CategoryNodeModule, "__crypto.cipherSetTag", nil, ir.TypeVoid, 2, 2)
	register([]string{"__scriptgo.cipherSetAutoPadding"}, CategoryNodeModule, "__crypto.cipherSetAutoPadding", nil, ir.TypeVoid, 2, 2)
	register([]string{"__scriptgo.cipherDestroy"}, CategoryNodeModule, "__crypto.cipherDestroy", nil, ir.TypeVoid, 1, 1)
	register([]string{"__scriptgo.getCipherInfo"}, CategoryNodeModule, "__crypto.getCipherInfo", nil, ir.TypeString, 1, 1)
	register([]string{"__scriptgo.cryptoSign"}, CategoryNodeModule, "__crypto.sign", nil, ir.TypeBuffer, 3, 3)
	register([]string{"__scriptgo.cryptoVerify"}, CategoryNodeModule, "__crypto.verify", nil, ir.TypeBool, 4, 4)
	register([]string{"__scriptgo.publicEncrypt"}, CategoryNodeModule, "__crypto.publicEncrypt", nil, ir.TypeBuffer, 3, 3)
	register([]string{"__scriptgo.publicDecrypt"}, CategoryNodeModule, "__crypto.publicDecrypt", nil, ir.TypeBuffer, 3, 3)
	register([]string{"__scriptgo.privateEncrypt"}, CategoryNodeModule, "__crypto.privateEncrypt", nil, ir.TypeBuffer, 3, 3)
	register([]string{"__scriptgo.privateDecrypt"}, CategoryNodeModule, "__crypto.privateDecrypt", nil, ir.TypeBuffer, 3, 3)
	register([]string{"__scriptgo.generateKeyPairSync"}, CategoryNodeModule, "__crypto.generateKeyPairSync", nil, ir.TypeString, 3, 3)
	register([]string{"__scriptgo.keyDetails"}, CategoryNodeModule, "__crypto.keyDetails", nil, ir.TypeString, 1, 1)
	register([]string{"__scriptgo.dhCreate"}, CategoryNodeModule, "__crypto.dhCreate", nil, ir.TypePointer, 2, 2)
	register([]string{"__scriptgo.dhCreateGroup"}, CategoryNodeModule, "__crypto.dhCreateGroup", nil, ir.TypePointer, 1, 1)
	register([]string{"__scriptgo.dhGenerateKeys"}, CategoryNodeModule, "__crypto.dhGenerateKeys", nil, ir.TypeBuffer, 1, 1)
	register([]string{"__scriptgo.dhComputeSecret"}, CategoryNodeModule, "__crypto.dhComputeSecret", nil, ir.TypeBuffer, 2, 2)
	register([]string{"__scriptgo.dhGetKey"}, CategoryNodeModule, "__crypto.dhGetKey", nil, ir.TypeBuffer, 2, 2)
	register([]string{"__scriptgo.dhSetKey"}, CategoryNodeModule, "__crypto.dhSetKey", nil, ir.TypeVoid, 3, 3)
	register([]string{"__scriptgo.dhDestroy"}, CategoryNodeModule, "__crypto.dhDestroy", nil, ir.TypeVoid, 1, 1)
	register([]string{"__scriptgo.ecdhCreate"}, CategoryNodeModule, "__crypto.ecdhCreate", nil, ir.TypePointer, 1, 1)
	register([]string{"__scriptgo.ecdhGenerateKeys"}, CategoryNodeModule, "__crypto.ecdhGenerateKeys", nil, ir.TypeBuffer, 1, 1)
	register([]string{"__scriptgo.ecdhComputeSecret"}, CategoryNodeModule, "__crypto.ecdhComputeSecret", nil, ir.TypeBuffer, 2, 2)
	register([]string{"__scriptgo.ecdhGetKey"}, CategoryNodeModule, "__crypto.ecdhGetKey", nil, ir.TypeBuffer, 2, 2)
	register([]string{"__scriptgo.ecdhSetKey"}, CategoryNodeModule, "__crypto.ecdhSetKey", nil, ir.TypeVoid, 3, 3)
	register([]string{"__scriptgo.ecdhDestroy"}, CategoryNodeModule, "__crypto.ecdhDestroy", nil, ir.TypeVoid, 1, 1)
	register([]string{"__scriptgo.spkacVerify"}, CategoryNodeModule, "__crypto.spkacVerify", nil, ir.TypeBool, 1, 1)
	register([]string{"__scriptgo.spkacExportChallenge"}, CategoryNodeModule, "__crypto.spkacExportChallenge", nil, ir.TypeString, 1, 1)
	register([]string{"__scriptgo.spkacExportPublicKey"}, CategoryNodeModule, "__crypto.spkacExportPublicKey", nil, ir.TypeString, 1, 1)
	register([]string{"__scriptgo.x509CheckPrivateKey"}, CategoryNodeModule, "__crypto.x509CheckPrivateKey", nil, ir.TypeBool, 2, 2)
	register([]string{"__scriptgo.x509Verify"}, CategoryNodeModule, "__crypto.x509Verify", nil, ir.TypeBool, 2, 2)
	register([]string{"__scriptgo.getFips"}, CategoryNodeModule, "__crypto.getFips", nil, ir.TypeNumber, 0, 0)
	register([]string{"__scriptgo.setFips"}, CategoryNodeModule, "__crypto.setFips", nil, ir.TypeVoid, 1, 1)
	register([]string{"__scriptgo.secureHeapUsed"}, CategoryNodeModule, "__crypto.secureHeapUsed", nil, ir.TypeString, 0, 0)
	register([]string{"__scriptgo.setEngine"}, CategoryNodeModule, "__crypto.setEngine", nil, ir.TypeVoid, 1, 2)
	...
	register([]string{"os.availableParallelism", "__scriptgo.availableParallelism", "availableParallelism"}, CategoryNodeModule, "__os.available_parallelism", nil, ir.TypeNumber, 0, 0)
	register([]string{"os.hostname", "__scriptgo.hostname", "hostname"}, CategoryNodeModule, "__os.hostname", nil, ir.TypeString, 0, 0)
	register([]string{"__scriptgo.loadavg"}, CategoryNodeModule, "__os.loadavg", nil, ir.TypeString, 0, 0)
	...
	register([]string{"__scriptgo.childProcessSpawnAsync"}, CategoryNodeModule, "__child_process.spawnAsync", []ir.Type{ir.TypeString, ir.TypeStringArray, ir.TypeString}, ir.Type("object:ChildProcessSpawnResult"), 1, 3)
	register([]string{"__scriptgo.childProcessPollStatus"}, CategoryNodeModule, "__child_process.pollStatus", []ir.Type{ir.TypeNumber}, ir.Type("object:ChildProcessPollResult"), 1, 1)
	register([]string{"__scriptgo.childProcessPipeRead"}, CategoryNodeModule, "__child_process.pipeRead", []ir.Type{ir.TypeNumber, ir.TypeNumber}, ir.Type("object:ChildProcessReadResult"), 1, 2)
	register([]string{"__scriptgo.childProcessPipeWrite"}, CategoryNodeModule, "__child_process.pipeWrite", []ir.Type{ir.TypeNumber, ir.TypeString, ir.TypeNumber}, ir.TypeNumber, 3, 3)
	register([]string{"__scriptgo.childProcessPipeClose"}, CategoryNodeModule, "__child_process.pipeClose", []ir.Type{ir.TypeNumber}, ir.TypeVoid, 1, 1)
	register([]string{"__scriptgo.childProcessKill"}, CategoryNodeModule, "__child_process.kill", []ir.Type{ir.TypeNumber, ir.TypeNumber}, ir.TypeBool, 1, 2)

	register([]string{"__scriptgo.fsWatchCreate"}, CategoryNodeModule, "__fs.watchCreate", []ir.Type{ir.TypeString}, ir.TypeNumber, 1, 1)
	register([]string{"__scriptgo.fsWatchPoll"}, CategoryNodeModule, "__fs.watchPoll", []ir.Type{ir.TypeNumber}, ir.Type("object:FSWatchPollResult"), 1, 1)
	register([]string{"__scriptgo.fsWatchClose"}, CategoryNodeModule, "__fs.watchClose", []ir.Type{ir.TypeNumber}, ir.TypeVoid, 1, 1)
