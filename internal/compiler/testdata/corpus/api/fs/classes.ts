...
// @api: fs.fs.FSWatcher
// @expect: true
const fsw = new fs.FSWatcher();
console.log(fsw !== null);

// @api: fs.FSWatcher.close
// @expect: true
fsw.close();
console.log(true);

// @api: fs.FSWatcher.ref
// @expect: true
fsw.ref();
console.log(true);

// @api: fs.FSWatcher.unref
// @expect: true
fsw.unref();
console.log(true);

// @api: fs.fs.StatWatcher
// @expect: true
const stw = new fs.StatWatcher();
console.log(stw !== null);

// @api: fs.StatWatcher.ref
// @expect: true
stw.ref();
console.log(true);

// @api: fs.StatWatcher.unref
// @expect: true
stw.unref();
console.log(true);

// @api: fs.fs.ReadStream
// @expect: true
const rs = new fs.ReadStream();
console.log(rs !== null);

// @api: fs.ReadStream.bytesRead
// @expect: true
console.log(rs.bytesRead === 0);

// @api: fs.ReadStream.path
// @expect: true
console.log(rs.path === "");

// @api: fs.ReadStream.pending
// @expect: true
console.log(rs.pending === false);

// @api: fs.fs.WriteStream
// @expect: true
const ws = new fs.WriteStream();
console.log(ws !== null);

// @api: fs.WriteStream.close
// @expect: true
ws.close();
console.log(true);

// @api: fs.WriteStream.bytesWritten
// @expect: true
console.log(ws.bytesWritten === 0);

// @api: fs.WriteStream.path
// @expect: true
console.log(ws.path === "");

// @api: fs.WriteStream.pending
// @expect: true
console.log(ws.pending === false);
