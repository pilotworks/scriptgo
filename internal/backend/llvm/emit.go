...
func EmitWithOptions(module ir.Module, options Options) (string, error) {
	...
	out.WriteString("declare i32 @scriptgo_object_is_frozen(ptr, ptr)\n")
	out.WriteString("declare i32 @scriptgo_object_is_sealed(ptr, ptr)\n")
	out.WriteString("declare i32 @scriptgo_object_is_extensible(ptr, ptr)\n")
	...
	out.WriteString("declare i32 @scriptgo_crypto_random_fill(ptr, double, double, ptr)\n")
	...
	out.WriteString("declare i32 @scriptgo_console_log_buffer(ptr)\n")
	out.WriteString("declare i32 @scriptgo_console_info_buffer(ptr)\n")
	out.WriteString("declare i32 @scriptgo_console_debug_buffer(ptr)\n")
	out.WriteString("declare i32 @scriptgo_console_warn_buffer(ptr)\n")
	out.WriteString("declare i32 @scriptgo_console_error_buffer(ptr)\n\n")
	out.WriteString("declare i32 @scriptgo_json_inspect_object(ptr, ptr)\n")
	out.WriteString("declare i32 @scriptgo_console_inspect_buffer(ptr, ptr)\n\n")
	out.WriteString("declare i32 @scriptgo_console_inspect_array(ptr, ptr)\n")
	...
	out.WriteString("declare i32 @scriptgo_intl_segments_length(ptr, ptr)\n")
	out.WriteString("declare i32 @scriptgo_intl_segments_get(ptr, double, ptr)\n")
	out.WriteString("declare i32 @scriptgo_intl_segments_containing(ptr, double, ptr)\n")
